...
ALTER TABLE PUBLIC.MOVIE ADD CONSTRAINT UK_MOVIE (PROFILE_ID,MOVIE_ID);
...
ALTER TABLE PUBLIC.REMINDER ADD CONSTRAINT PK_MOVIE PRIMARY KEY (ID);
ALTER TABLE PUBLIC.REMINDER ADD CONSTRAINT FK_REMINDER_PROFILE FOREIGN KEY (PROFILE_ID) REFERENCES PUBLIC.PROFILE (ID);
ALTER TABLE PUBLIC.REMINDER ADD CONSTRAINT FK_REMINDER_MOVIE FOREIGN KEY (MOVIE_ID) REFERENCES PUBLIC.MOVIE (ID);
